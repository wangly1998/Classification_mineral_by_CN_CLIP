...
def parse_args():
    ...
    parser.add_argument("--raw-ckpt-path", type=str, required=True,
                        help="specify the path of the original openai checkpoint")
    parser.add_argument("--new-ckpt-path", type=str, default=None,
                        help="specify the path of the transformed checkpoint")
