...
def train_model(model, train_loader, valid_loader, criterion, optimizer, num_epochs=10):
    ...
    for epoch in range(num_epochs):
        ...
        logging.info(f'Epoch {epoch+1}/{num_epochs}, Loss: {epoch_loss:.4f}, Acc: {epoch_acc:.4f}')
        ...
        with torch.no_grad():
            ...
            logging.info(f'test Acc: {val_acc:.4f}')
...
# 设置日志记录
logging.basicConfig(
    filename='training_log_efficientnet_b0.log',
    level=logging.INFO,
...
# 计算测试集上的指标
top_k_recall, precision, recall, f1 = calculate_metrics(trained_model, test_loader, k_list=[1, 5, 10])
